  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    if (input.trim()) {
      ...
      try {
        ...
        setMessages((prevMessages) => [
          ...prevMessages,
          { user: "Assistant", text: data.response },
        ]);
      } catch (error) {
        console.error("Error:", error);
        setMessages((prevMessages) => [
          ...prevMessages,
          { user: "Assistant", text: "Sorry, something went wrong. Please try again." },
        ]);
      } finally {
        setIsLoading(false);
      }
            ...
            <div className="h-[300px] overflow-y-auto p-4 bg-gray-50">
              ...
              {isLoading && (
                <motion.div
                  ...
                  className="text-left"
                >
                  <p className="bg-orange-300 text-white inline-block px-4 py-2 rounded-lg max-w-[80%] break-words">
                    Thinking...
                  </p>
                </motion.div>
              )}
