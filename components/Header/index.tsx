              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <div>
                  <a
                    ...
                    className="from-yellow-300 to-yellow-500 hover:from-yellow-400 hover:to-yellow-600 rounded-lg bg-gradient-to-r px-6 py-3 font-bold text-black shadow-lg transition-all duration-300"
                  >
                    Créer un compte
                  </a>{" "}
                  <a
